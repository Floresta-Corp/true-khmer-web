/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dea5b37e4c47ff1bfd37f1edd5bfc454)
// Runtime types generated with workerd@1.20260907.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	API_BASE_URL: string;
	PLUMPI_ENDPOINT: string;
	VITE_PLUMPI_WEB: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_BASE_URL" | "PLUMPI_ENDPOINT" | "VITE_PLUMPI_WEB" | "VITE_GOOGLE_CLIENT_ID" | "SESSION_SECRET" | "VITE_R2_PUBLIC_BASE_URL">> {}
}
