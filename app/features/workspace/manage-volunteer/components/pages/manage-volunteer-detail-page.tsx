...
import { CalendarRange, EyeOff, HandHeart, Pencil, Share2 } from "lucide-react";
import { motion, useReducedMotion } from "motion/react";
import type { ManagePostDetailLoaderData } from "../../services/manage-volunteer-detail.loader";
...
import type { ManagePostStatus } from "~/features/workspace/manage-volunteer/types";
...
import ManagePostOption from "../dropdown/manage-volunteer-option";
...
export default function ManagePostingDetailPage() {
  ...
  const editRoute = `/volunteer/edit/${id}`;
    ...
    >
      <div className="p-4 pb-24 sm:p-8 md:p-10">
        <motion.div className="mb-6" {...fadeUp(0.05)}>
          <BackToButton to="/workspace/volunteer" />
        </motion.div>
