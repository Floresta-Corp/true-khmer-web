import type { Route } from "project-types/workspace/my-blog/route/+types/my-blog.image-presign";
...
export async function myBlogImagePresignAction({ request }: Route.ActionArgs) {
