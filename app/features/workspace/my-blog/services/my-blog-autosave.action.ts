import type { Route } from "project-types/workspace/my-blog/route/+types/my-blog.autosave";
import {
  createMyBlogPost,
  updateMyBlogPost,
...
export async function myBlogAutosaveAction({ request }: Route.ActionArgs) {
