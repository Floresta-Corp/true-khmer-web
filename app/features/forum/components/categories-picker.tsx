      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            type="button"
            variant="ghost"
            className="flex h-11 w-full items-center justify-between rounded-lg border border-transparent bg-[#f8fafc] px-3 text-left text-sm font-medium text-[#344256] transition-colors outline-none focus:border-[#2f6fe4] focus-visible:border-[#2f6fe4] focus-visible:ring-1 focus-visible:outline-none"
          >
