...
import LaunchpadSeekingCollaborationCard from "../card/launchpad-seeking-collaboration-card";
import LaunchpadPresentationCard from "../card/launchpad-presentation-card";
import AuthorCard from "~/components/author-card";
import BackToButton from "~/components/back-to-button";
import IconButton from "~/components/icon-button";
import { Card, CardContent } from "~/components/ui/card";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "~/components/ui/tabs";
import type { loader } from "../../route/launchpad.$id";
import LaunchpadJoinProjectCard from "../card/launchpad-join-project-card";
