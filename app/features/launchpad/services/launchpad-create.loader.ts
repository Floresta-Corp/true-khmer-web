import type { Route as LaunchpadCreateRoute } from "project-types/launchpad/route/+types/launchpad.create";
import { requireUser } from "~/lib/server/route-guards.server";
import {
  withAuthData,
  withAuthRedirect,
} from "~/lib/server/auth-response.server";
import { getPublicLaunchpadCategories } from "~/routes/api/launchpad/launchpad.server";
