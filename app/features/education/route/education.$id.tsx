...
import { CourseDetailCurriculum } from "../components/course-detail-curriculum";
...
import { CourseRecommendedList } from "../components/course-recommended-list";
import { CourseReviewRow } from "../components/course-review-row";
...
export default function CourseDetailPage() {
  const { course, recommended } = useLoaderData<typeof loader>();
  ...
  const downloadable = course.curriculum
    ...
    .filter((lesson) => lesson.type === "pdf" && lesson.sourceUrl);
