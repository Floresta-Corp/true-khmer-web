    ...
    <main className="min-h-full bg-[#f8fafc] px-4 py-6 dark:bg-slate-950 sm:px-6 lg:px-10 lg:py-8">
      <div className="mx-auto w-full max-w-4xl space-y-6">
        ...
        <nav className="flex items-center gap-1.5 text-sm text-slate-500 dark:text-slate-400">
          ...
          <span>/</span>
          <span className="text-slate-900 dark:text-white">Create New Partner</span>
        </nav>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <PartnerTextField id={companyNameId} label="Company Name" required error={errors.companyName} value={values.companyName} onChange={(e) => handleChange("companyName", e.target.value)} placeholder="Enter company name" disabled={isSubmitting} />

            <PartnerTextField id={registrationNumberId} label="Registration Number" error={errors.registrationNumber} value={values.registrationNumber} onChange={(e) => handleChange("registrationNumber", e.target.value)} placeholder="Enter company registration number" disabled={isSubmitting} />

            <PartnerTextField id={companyEmailId} label="Company Email" type="email" required error={errors.companyEmail} value={values.companyEmail} onChange={(e) => handleChange("companyEmail", e.target.value)} placeholder="Enter company email" disabled={isSubmitting} />
            ...
            <PartnerTextField id={zipCodeId} label="ZIP Code" error={errors.zipCode} value={values.zipCode} onChange={(e) => handleChange("zipCode", e.target.value)} placeholder="Enter ZIP code" disabled={isSubmitting} />

            <PartnerSelectField id={sectorOfActivityId} label="Sector of Activity" required error={errors.sectorOfActivity} value={values.sectorOfActivity} onValueChange={(value) => handleChange("sectorOfActivity", value)} placeholder="Select business sector" disabled={isSubmitting} options={partnerSectorOptions} />

            <PartnerTextField id={websiteId} label="Company Website" type="url" fieldClassName="lg:col-span-2" error={errors.website} value={values.website} onChange={(e) => handleChange("website", e.target.value)} placeholder="https://www.company.com" disabled={isSubmitting} />

            <FormField id={bioId} label="Company Bio" className="lg:col-span-2" error={errors.bio}>
              <Textarea
                id={bioId}
                value={values.bio}
            ...
            <FormField id={descriptionId} label="Company Description" className="lg:col-span-2" error={errors.description}>
              <Textarea
                id={descriptionId}
          ...
          <FormSectionHeading title="Company Social Media (Optional)" accent="slate" />

          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <PartnerTextField id={companyFacebookUrlId} label="Facebook URL" type="url" error={errors.companyFacebookUrl} value={values.companyFacebookUrl} onChange={(e) => handleChange("companyFacebookUrl", e.target.value)} placeholder="https://facebook.com/company" disabled={isSubmitting} />
            <PartnerTextField id={companyLinkedinUrlId} label="LinkedIn URL" type="url" error={errors.companyLinkedinUrl} value={values.companyLinkedinUrl} onChange={(e) => handleChange("companyLinkedinUrl", e.target.value)} placeholder="https://linkedin.com/company/company" disabled={isSubmitting} />
            <PartnerTextField id={companyTelegramId} label="Telegram" error={errors.companyTelegram} value={values.companyTelegram} onChange={(e) => handleChange("companyTelegram", e.target.value)} placeholder="without @ just username" disabled={isSubmitting} />
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <PartnerTextField id={firstNameId} label="First Name" required error={errors.firstName} value={values.firstName} onChange={(e) => handleChange("firstName", e.target.value)} placeholder="Enter first name" disabled={isSubmitting} />
            <PartnerTextField id={lastNameId} label="Last Name" required error={errors.lastName} value={values.lastName} onChange={(e) => handleChange("lastName", e.target.value)} placeholder="Enter last name" disabled={isSubmitting} />
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <PartnerTextField id={userFacebookUrlId} label="Facebook URL" type="url" error={errors.userFacebookUrl} value={values.userFacebookUrl} onChange={(e) => handleChange("userFacebookUrl", e.target.value)} placeholder="https://facebook.com/username" disabled={isSubmitting} />
            <PartnerTextField id={userLinkedinUrlId} label="LinkedIn URL" type="url" error={errors.userLinkedinUrl} value={values.userLinkedinUrl} onChange={(e) => handleChange("userLinkedinUrl", e.target.value)} placeholder="https://linkedin.com/in/username" disabled={isSubmitting} />
            <PartnerTextField id={userTelegramId} label="Telegram" error={errors.userTelegram} value={values.userTelegram} onChange={(e) => handleChange("userTelegram", e.target.value)} placeholder="@username or link" disabled={isSubmitting} />
          </div>
        </div>
      </div>
