  ...
  return (
    ...
    >
      ...
      >
        {/* Content Box */}
        <div
          className="relative flex w-full max-w-[672px] flex-col items-center justify-center gap-[23px]"
          data-name="motion.div"
        ...
        >
          ...
          {/* Action Buttons */}
          <div
            className="flex w-full items-center justify-center gap-[14px]"
            style={{ height: "42px" }}
            data-name="div"
          ...
          >
            ...
            <button
              ...
              className="flex items-center gap-[7px] rounded-full bg-white px-[18px] py-2 transition-colors hover:bg-gray-100"
              data-name="Link"
            ...
            <button
              ...
              className="flex h-[40px] items-center justify-center rounded-full border border-white/20 bg-white/10 px-[29px] py-1 transition-colors hover:bg-white/20"
              data-name="Link"
