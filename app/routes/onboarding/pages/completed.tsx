...
export default function OnboardingCompletedPage() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-white text-[#111827]">
      ...
      <main className="relative flex min-h-[calc(100vh-60px)] items-center justify-center overflow-x-hidden overflow-y-auto px-6 py-16.75 font-['Inter'] sm:px-8 md:px-12 lg:px-20 xl:px-84">
