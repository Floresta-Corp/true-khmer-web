...
export default [
  layout("layout/app-layout.tsx", [
    layout("layout/footer-layout.tsx", [
      ...
      route("forumv2", "features/forum/routes/forum.new.tsx"),
      route("forum/:questionId", "features/forum/routes/forum.$id.tsx"),
      ...
      route("volunteer/:id", "features/volunteer/routes/volunteer.$id.tsx"),
      route("poc", "features/poc/routes/poc.tsx"),
      route("poc/:id", "features/poc/routes/poc.$id.tsx"),
      route("launchpad", "features/launchpad/routes/launchpad.tsx"),
      route("launchpad/:id", "features/launchpad/routes/launchpad.$id.tsx"),
    ]),
