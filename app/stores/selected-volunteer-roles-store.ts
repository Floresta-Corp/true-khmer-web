...
interface VolunteerSelectedRolesState {
...
export const useVolunteerSelectedRoles = create<VolunteerSelectedRolesState>(
  (set, get) => ({
    selectedRoleIds: [],
    topPickRoleId: null,
    ...
    removeRole: (roleId: string) => {
      set((state) => ({
        ...
        topPickRoleId:
          state.topPickRoleId === roleId ? null : state.topPickRoleId,
      }));
    },
