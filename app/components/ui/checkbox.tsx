...
const checkboxBaseClasses =
  "peer relative flex size-4 shrink-0 items-center justify-center rounded-sm border border-input transition-colors outline-none group-has-disabled/field:opacity-50 after:absolute after:-inset-x-3 after:-inset-y-2";

const checkboxInteractionClasses =
...
const checkboxValidationClasses =
...
const checkboxStateClasses =
  "data-checked:border-primary data-checked:bg-primary data-checked:text-primary-foreground dark:data-checked:bg-primary dark:bg-input/30";
