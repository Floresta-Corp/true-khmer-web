...
const CertificateErrorResponse = z.object({ ok: z.literal(false), error: z.string() });
...
const CourseResponse = z.object({ id: z.string().uuid(), title: z.string(), description: z.string(), categoryId: z.string().uuid(), coverImageKey: z.string().nullable(), coverImageUrl: z.string().nullable(), price: z.number(), status: z.enum(["DRAFT", "PENDING", "PUBLISHED", "UNPUBLISHED"]), difficulty: z.enum(["BEGINNER", "INTERMEDIATE", "ADVANCE", "ALL_LEVELS"]).nullable(), format: z.enum(["MULTI", "SINGLE"]), skills: z.array(z.string()), outcomes: z.array(z.string()), tags: z.array(z.string()), certificateKind: z.enum(["PARTICIPATION", "COMPLETION"]).nullable(), quizPassMark: z.number().int(), createdBy: z.string().uuid(), creator: z.object({ id: z.string().uuid(), name: z.string(), email: z.string().email(), avatarKey: z.string().nullable() }).nullish(), updatedBy: z.string().uuid().nullable(), publishedAt: z.string().nullable(), publishedBy: z.string().uuid().nullable(), unpublishedAt: z.string().nullable(), unpublishedBy: z.string().uuid().nullable(), rejectionNote: z.string().nullable(), rejectedAt: z.string().nullable(), rejectedBy: z.string().uuid().nullable(), createdAt: z.string(), updatedAt: z.string(), studentCount: z.number().int().gte(0).nullish() });
const PublicCourseListItem = CourseResponse.and(z.object({ studentCount: z.number().int().gte(0), categoryName: z.string().nullable(), lessonCount: z.number().int().gte(0), rating: z.object({ average: z.number().nullable(), total: z.number().int().gte(0) }) }));
...
const ListCourseRecommendationsResponse = z.object({ ok: z.literal(true), courses: z.array(PublicCourseListItem) });
...
const LeaveCourseResponse = z.object({ ok: z.literal(true), left: z.boolean() });
...
const GetCourseCertificateResponse = z.object({ ok: z.literal(true), earned: z.boolean(), certificate: CertificateResponse.nullable() });

const ShareCourseCertificateResponse = z.object({ ok: z.literal(true), certificate: CertificateResponse });
...
const MyClassesStats = z.object({ inProgress: z.number().int().gte(0), completed: z.number().int().gte(0), timeLearnedSeconds: z.number().int().gte(0), certificates: z.number().int().gte(0) });

const ListMyClassesResponse = z.object({ ok: z.literal(true), courses: z.array(MyClass), counts: MyClassCounts, stats: MyClassesStats, pagination: z.object({ page: z.number().int().gt(0), limit: z.number().int().gt(0), total: z.number().int().gte(0), totalPages: z.number().int().gte(0) }) });
...
export const schemas = {
	...
	CreateCourseRequest,
	GetCourseResponse,
	ListCourseRecommendationsResponse,
	...
	GetCourseCertificateResponse,
	ShareCourseCertificateResponse,
	CourseStudent,
	CourseStudentCounts,
...
const endpoints = makeApi([
	...
	},
	{
		...
		parameters: [
			...
			},
			{
				name: "sortBy",
				type: "Query",
				schema: z.enum(["newest", "oldest", "az", "price", "popular", "rating"]).optional().default("newest")
			},
		],
	...
	{
		method: "get",
		path: "/v1/education-center/courses/:id/certificate",
		alias: "getV1educationCentercoursesIdcertificate",
		requestFormat: "json",
		parameters: [
			{
				name: "id",
		...
		response: GetCourseCertificateResponse,
		errors: [
			{
				status: 401,
	...
	{
		method: "post",
		path: "/v1/education-center/courses/:id/certificate/share",
		alias: "postV1educationCentercoursesIdcertificateshare",
		requestFormat: "json",
		parameters: [
			{
				name: "id",
		...
		response: ShareCourseCertificateResponse,
		errors: [
			{
				status: 401,
				description: `Not signed in`,
			...
			{
				status: 403,
				description: `Course not finished`,
				schema: CertificateErrorResponse
			},
			{
				status: 404,
	...
	},
	{
		method: "delete",
		path: "/v1/education-center/courses/:id/certificate/share",
		alias: "deleteV1educationCentercoursesIdcertificateshare",
		requestFormat: "json",
		parameters: [
			{
				name: "id",
	...
	},
	{
		method: "delete",
		path: "/v1/education-center/courses/:id/enroll",
		alias: "deleteV1educationCentercoursesIdenroll",
		requestFormat: "json",
		parameters: [
			{
				name: "id",
		...
		errors: [
			...
			{
				status: 404,
				description: `Not enrolled on this course`,
				schema: z.void()
			},
		]
	},
	...
	{
		method: "get",
		path: "/v1/education-center/courses/:id/recommendations",
		alias: "getV1educationCentercoursesIdrecommendations",
		requestFormat: "json",
		parameters: [
			{
				name: "id",
			...
			},
			{
				name: "limit",
				type: "Query",
				schema: z.number().int().gte(1).lte(12).optional().default(4)
			},
		],
		response: ListCourseRecommendationsResponse,
		errors: [
			{
				status: 400,
				description: `Validation failed`,
	...
	{
		method: "get",
		path: "/v1/education-center/my-classes",
		alias: "getV1educationCentermyClasses",
		requestFormat: "json",
		parameters: [
			{
				name: "tab",
				type: "Query",
				schema: z.enum(["learning", "in-progress", "saved", "completed"]).optional().default("learning")
			},
			{
				name: "search",
				type: "Query",
		...
		response: ListMyClassesResponse,
		errors: [
			{
				status: 400,
				description: `Validation failed`,
	...
	{
		method: "get",
		path: "/v1/plumpi/events/slug/:slug/exhibitor-categories",
		alias: "getV1plumpieventsslugSlugexhibitorCategories",
		requestFormat: "json",
		parameters: [
			{
				name: "slug",
		...
		response: z.object({ ok: z.literal(true), categories: z.array(z.record(z.string(), z.unknown().nullable())) }),
		errors: [
			{
				status: 400,
				description: `Invalid exhibitor query`,
				schema: z.object({ ok: z.literal(false), error: z.string(), code: z.string().optional() })
			},
			{
				status: 404,
	...
	{
		method: "get",
		path: "/v1/plumpi/events/slug/:slug/exhibitors",
		alias: "getV1plumpieventsslugSlugexhibitors",
		requestFormat: "json",
		parameters: [
			{
				name: "slug",
		...
		response: z.object({ ok: z.literal(true), exhibitors: z.array(z.record(z.string(), z.unknown().nullable())), meta: z.object({ page: z.number().int(), limit: z.number().int(), total: z.number().int(), totalPages: z.number().int() }) }),
		errors: [
			{
				status: 400,
				description: `Invalid exhibitor query`,
	...
	{
		method: "get",
		path: "/v1/plumpi/events/slug/:slug/floor-plan-photos",
		alias: "getV1plumpieventsslugSlugfloorPlanPhotos",
		requestFormat: "json",
		parameters: [
			{
				name: "slug",
		...
		response: z.object({ ok: z.literal(true), photos: z.array(z.record(z.string(), z.unknown().nullable())) }),
		errors: [
			{
				status: 400,
				description: `Invalid exhibitor query`,
	...
	{
		method: "get",
		path: "/v1/plumpi/events/slug/:slug/organizer",
		alias: "getV1plumpieventsslugSlugorganizer",
		requestFormat: "json",
		parameters: [
			{
				name: "slug",
		...
		response: z.object({ ok: z.literal(true), organizer: z.record(z.string(), z.unknown().nullable()) }),
		errors: [
			{
				status: 400,
				description: `Invalid event slug`,
				schema: z.object({ ok: z.literal(false), error: z.string(), code: z.string().optional() })
			},
			{
				status: 404,
				description: `Event or its organizer was not found`,
				schema: z.object({ ok: z.literal(false), error: z.string(), code: z.string().optional() })
			},
			{
				status: 500,
	...
	{
		method: "get",
		path: "/v1/plumpi/events/slug/:slug/photos",
		alias: "getV1plumpieventsslugSlugphotos",
		requestFormat: "json",
		parameters: [
			{
				name: "slug",
	...
	{
		method: "get",
		path: "/v1/plumpi/events/slug/:slug/sessions",
		alias: "getV1plumpieventsslugSlugsessions",
		requestFormat: "json",
		parameters: [
			{
				name: "slug",
		...
		response: z.object({ ok: z.literal(true), sessions: z.array(z.record(z.string(), z.unknown().nullable())) }),
		errors: [
			{
				status: 400,
				description: `Invalid event slug`,
	...
	{
		method: "get",
		path: "/v1/plumpi/tickets/event/:eventId",
		alias: "getV1plumpiticketseventEventId",
		requestFormat: "json",
		parameters: [
			{
				name: "eventId",
		...
		response: z.object({ event: z.record(z.string(), z.unknown().nullable()), tickets: z.array(z.record(z.string(), z.unknown().nullable())), ok: z.literal(true) }),
		errors: [
			{
				status: 400,
	...
	{
		method: "get",
		path: "/v1/plumpi/tickets/me",
		alias: "getV1plumpiticketsme",
		requestFormat: "json",
		parameters: [
			{
				name: "page",
			...
			},
			{
				name: "source",
				type: "Query",
				schema: z.enum(["web", "mobile", "api", "pos"]).optional()
			},
			{
				name: "timeFilter",
				type: "Query",
				schema: z.enum(["upcoming", "past"]).optional()
			},
		],
		response: z.object({ ok: z.literal(true), tickets: z.array(z.record(z.string(), z.unknown().nullable())), meta: z.object({ page: z.number().int(), limit: z.number().int(), total: z.number().int(), totalPages: z.number().int() }) }),
		errors: [
			{
				status: 400,
				description: `Invalid ticket-list query`,
				schema: z.object({ ok: z.literal(false), error: z.string(), code: z.string().optional() })
			},
			{
				status: 401,
	...
	{
		method: "get",
		path: "/v1/profile/:userId/certificates",
		alias: "getV1profileUserIdcertificates",
		requestFormat: "json",
		parameters: [
			{
				name: "userId",
...
export type ListCourseRecommendationsResponse = z.infer<typeof schemas.ListCourseRecommendationsResponse>;
...
export type LeaveCourseResponse = z.infer<typeof schemas.LeaveCourseResponse>;
...
export type GetCourseCertificateResponse = z.infer<typeof schemas.GetCourseCertificateResponse>;
export type ShareCourseCertificateResponse = z.infer<typeof schemas.ShareCourseCertificateResponse>;
...
export type ListMyClassesResponse = z.infer<typeof schemas.ListMyClassesResponse>;
