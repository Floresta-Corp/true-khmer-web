...
const AuthUserProfile = z.object({
  id: z.string(),
...
const AuthUser = z.object({
  ...
  signupCompletedAt: z.union([z.string(), z.string(), z.unknown()]).optional(),
...
const AuthPhoneForm = z.object({
  country: z.string(),
  nationalNumber: z.string(),
});
const AuthWaitlistPrefill = z.object({
  firstName: z.string(),
  lastName: z.string(),
  phone: AuthPhoneForm,
  email: z.string().email(),
...
const CompleteSignUpResponse = z.object({
  success: z.literal(true),
  message: z.string(),
  user: AuthUser,
...
const AuthProtectedErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
...
const AuthGoogleRequest = z.object({
...
const AuthVerifyRegisterOtpRequest = z.object({
  email: z.string().min(1).email(),
  otp: z.string().min(6).max(6),
});
const AuthResendRegisterOtpRequest = z.object({
  email: z.string().min(1).email(),
});
const ResendRegisterOtpResponse = z.object({
  success: z.boolean(),
  message: z.string(),
});
...
const AuthForgotPasswordRequest = z.object({
  email: z.string().min(1).email(),
  resetPageUrl: z.string().min(1),
});
const ForgotPasswordResponse = z.object({
  success: z.literal(true),
  message: z.string(),
});
const AuthResetPasswordRequest = z.object({
...
const AdminLoginOtpChallengeResponse = z.object({
...
const AdminVerifyLoginOtpRequest = z.object({
  challengeId: z.string().uuid(),
...
const AdminRefreshResponse = z.object({
  accessToken: z.string(),
  refreshToken: z.string(),
  accessTokenExpiresAt: z.string().datetime({ offset: true }),
  refreshTokenExpiresAt: z.string().datetime({ offset: true }),
});
const AdminPresignAvatarUploadRequest = z.object({
  contentType: z.string(),
  fileSize: z.number().int().gt(0).lte(5242880),
});
const AdminPresignAvatarUploadResponse = z.object({
  ok: z.boolean(),
  upload: z.object({
...
const AdminUpdateProfileRequest = z
  ...
  .partial();
const AdminUpdateProfileResponse = z.object({
  ok: z.boolean(),
  admin: z.object({
    id: z.string(),
    email: z.string(),
...
const AdminLogoutResponse = z.object({
  success: z.boolean(),
  message: z.string(),
});
const ContentModeratorReportType = z.object({
  id: z.string(),
  name: z.string(),
});
const ContentModeratorReportReporter = z.object({
  id: z.string(),
  name: z.string(),
  avatarKey: z.string().nullable(),
});
const ContentModeratorReportSolver = z.object({
  id: z.string(),
  firstName: z.string().nullable(),
  lastName: z.string().nullable(),
});
const ContentModeratorReport = z.object({
  id: z.string().uuid(),
...
const ListContentModeratorReportsResponse = z.object({
  ok: z.boolean(),
  reports: z.array(ContentModeratorReport),
  pagination: CursorPagination,
});
const UpdateContentModeratorReportReviewRequest = z.object({
  reportUuid: z
    .string()
    .regex(
...
const UpdateContentModeratorReportReviewResponse = z.object({
  ok: z.boolean(),
  report: ContentModeratorReport,
});
const AdminDashboardResponse = z.object({
  ok: z.literal(true),
  dashboard: z.object({
    summary: z.object({
    ...
    demographics: z.object({
      genderBreakdown: z.array(
        z.object({ label: z.string(), count: z.number().int().gte(0) }),
      ),
      ageGroups: z.array(
        z.object({ label: z.string(), count: z.number().int().gte(0) }),
      ),
...
const AdminDashboardErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
const AcceptModeratorInviteRequest = z.object({
  token: z.string().min(1),
  firstName: z.string().min(1).max(100),
  lastName: z.string().min(1).max(100),
...
const ListModeratorsResponse = z.object({
  ok: z.boolean(),
  moderators: z.array(Moderator),
  pagination: CursorPagination,
});
const CreateModeratorRequest = z.object({ email: z.string().min(1) });
...
const AdminUserManagementTier = z.object({
  id: z.string().uuid(),
  slug: z.string(),
  name: z.string(),
...
const AdminUserManagementUser = z.object({
  id: z.string().uuid(),
  name: z.string(),
  firstName: z.string(),
  lastName: z.string(),
...
const AdminUserManagementListResponse = z.object({
  ok: z.literal(true),
...
const AdminUserManagementPoints = z.object({
  activePoints: z.number().int(),
  tierPoints: z.number().int(),
  legacyPoints: z.number().int(),
  totalPoints: z.number().int(),
});
const AdminUserManagementActivity = z.object({
  id: z.string().uuid(),
  title: z.string(),
  actionType: z.string(),
  points: z.number().int(),
...
const AdminUserManagementDetailResponse = z.object({
  ok: z.literal(true),
...
const OnboardingProfileStepRequest = z.object({
...
const OnboardingInterestsStepRequest = z.object({
  interestIds: z
    .array(
      z
        .string()
...
const OnboardingContributionsStepRequest = z
  ...
  .partial();
const PresignAvatarUploadRequest = z.object({
  contentType: z.string(),
  fileSize: z.number().int().gt(0).lte(5242880),
});
const PresignAvatarUploadResult = z.object({
  uploadUrl: z.string(),
  method: z.literal("PUT"),
...
const PresignAvatarUploadResponse = z.object({
  ok: z.boolean(),
  upload: PresignAvatarUploadResult,
});
...
const GetCategoriesResponse = z.object({
  ok: z.boolean(),
...
const CreateCategoryResponse = z.object({
  ok: z.boolean(),
...
const CreateQuestionResponse = z.object({
  ok: z.boolean(),
  question: QuestionResponse,
});
const TrendingTagResponse = z.object({
  id: z.string(),
  name: z.string(),
  count: z.number(),
});
const GetTrendingTagsResponse = z.object({
  ok: z.boolean(),
  tags: z.array(TrendingTagResponse),
});
const GetMyQuestionsResponse = z.object({
  ok: z.boolean(),
  questions: z.array(QuestionResponse),
  pagination: z.object({
    limit: z.number(),
...
const GetSavedQuestionsResponse = z.object({
  ok: z.boolean(),
  questions: z.array(QuestionResponse),
  pagination: z.object({
    limit: z.number(),
...
const GetQuestionResponse = z.object({
  ok: z.boolean(),
  question: QuestionResponse,
});
const PresignForumQuestionImageUploadRequest = z.object({
  contentType: z.string(),
  fileSize: z.number().int().gt(0).lte(5242880),
});
const PresignForumQuestionImageUploadResult = z.object({
  uploadUrl: z.string(),
  method: z.literal("PUT"),
  requiredHeaders: z.object({
    "Content-Length": z.string(),
...
const PresignForumQuestionImageUploadResponse = z.object({
  ok: z.literal(true),
...
const RepliedAnswerResponse = z.object({
  id: z.string(),
  body: z.string(),
  author: z.object({
    id: z.string(),
...
const GetAnswersResponse = z.object({
  ok: z.boolean(),
  answers: z.object({
...
const AnswerQuestionResponse = z.object({
  id: z.string(),
  categoryId: z.string(),
  authorId: z.string(),
  title: z.string(),
...
const MyAnswerResponse = z.object({
  id: z.string(),
  body: z.string(),
  author: z.object({
    id: z.string(),
...
const MyAnswerDiscussionResponse = z.object({
  question: AnswerQuestionResponse,
  answers: z.array(MyAnswerResponse),
  myAnswerCount: z.number().int().gt(0),
  lastActivityAt: z.string(),
});
const MyAnswersPaginationResponse = z.object({
  limit: z.number().int().gt(0),
  hasMore: z.boolean(),
  nextCursor: z.string().nullable(),
  total: z.number().int().gte(0),
});
const GetMyAnswersResponse = z.object({
  ok: z.boolean(),
...
const EditAnswerResponse = z.object({
  ok: z.boolean(),
  answer: AnswerResponse,
});
const AnswerErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
...
const VoteAnswerResponse = z.object({
  ok: z.boolean(),
  answer: AnswerResponse,
});
const MarkBestAnswerResponse = z.object({
  ok: z.boolean(),
  answer: AnswerResponse,
});
const VolunteerCategoryResponse = z.object({
  id: z.string(),
  slug: z.string(),
  name: z.string(),
  description: z.string().nullable(),
...
const GetVolunteerCategoriesResponse = z.object({
  ok: z.literal(true),
  categories: z.array(VolunteerCategoryWithOpportunityCountResponse),
});
const VolunteerOperationErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
const CreateVolunteerCategoryRequest = z.object({
  name: z.string(),
  slug: z.string(),
...
const CreateVolunteerCategoryResponse = z.object({
  ok: z.literal(true),
  category: VolunteerCategoryResponse,
});
const VolunteerCategoryValidationErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
  issues: z.array(z.object({ path: z.string(), message: z.string() })),
});
const VolunteerLocationResponse = z.object({
  id: z.string(),
  name: z.string(),
});
const GetVolunteerLocationsResponse = z.object({
  ok: z.literal(true),
  locations: z.array(VolunteerLocationResponse),
});
const PresignVolunteerOpportunityCoverUploadRequest = z.object({
  contentType: z.string(),
  fileSize: z.number().int().gt(0).lte(5242880),
});
const PresignVolunteerOpportunityCoverUploadResult = z.object({
  uploadUrl: z.string(),
  method: z.literal("PUT"),
  requiredHeaders: z.object({
    "Content-Length": z.string(),
...
const PresignVolunteerOpportunityCoverUploadResponse = z.object({
  ok: z.literal(true),
  upload: PresignVolunteerOpportunityCoverUploadResult,
});
const PresignVolunteerApplicationDocumentUploadRequest = z.object({
  opportunityId: z
    .string()
    .regex(
...
const PresignVolunteerApplicationDocumentUploadResult = z.object({
  uploadUrl: z.string(),
  method: z.literal("PUT"),
  requiredHeaders: z.object({
    "Content-Length": z.string(),
  ...
  supportingDocument: z.object({ name: z.string(), key: z.string() }),
  expiresInSeconds: z.number(),
});
const PresignVolunteerApplicationDocumentUploadResponse = z.object({
  ok: z.literal(true),
  uploads: z.array(PresignVolunteerApplicationDocumentUploadResult),
});
const VolunteerOpportunityReference = z.object({
  id: z.string(),
  name: z.string(),
});
const VolunteerOpportunityListItemResponse = z.object({
  id: z.string(),
  title: z.string(),
  overview: z.string(),
...
const VolunteerOpportunitiesPaginationResponse = z.object({
  limit: z.number(),
  hasMore: z.boolean(),
  nextCursor: z.string().nullable(),
  total: z.number().int().gte(0),
});
const GetVolunteerOpportunitiesResponse = z.object({
  ok: z.literal(true),
  opportunities: z.array(VolunteerOpportunityListItemResponse),
  pagination: VolunteerOpportunitiesPaginationResponse,
});
const VolunteerOpportunityContact = z.object({
  email: z.string().max(320).email(),
  telegramUsername: z.string().nullish(),
  phone: z.string().nullish(),
  websiteUrl: z.string().nullish(),
});
const VolunteerOpportunityRoleRequest = z.object({
  title: z.string(),
...
const CreateVolunteerOpportunityPayload = z.object({
...
const VolunteerOpportunityContactResponse = z.object({
  email: z.string(),
  telegramUsername: z.string().nullable(),
  phone: z.string().nullable(),
  websiteUrl: z.string().nullable(),
});
const VolunteerOpportunityOrganizerResponse = z.object({
  id: z.string(),
  name: z.string(),
  avatarKey: z.string().nullable(),
...
const VolunteerOpportunityRoleResponse = z.object({
  id: z.string(),
  title: z.string(),
  capacity: z.number(),
...
const VolunteerOpportunityResponse = z.object({
  id: z.string(),
  category: VolunteerOpportunityReference,
  location: VolunteerOpportunityReference,
  title: z.string(),
...
const CreateVolunteerOpportunityResponse = z.object({
  ok: z.literal(true),
  opportunity: VolunteerOpportunityResponse,
});
const GetVolunteerOpportunityResponse = z.object({
  ok: z.literal(true),
  opportunity: VolunteerOpportunityResponse,
});
...
const CreateVolunteerApplicationRequest = z.object({
...
const VolunteerApplicationOpportunity = z.object({
  id: z.string(),
  title: z.string(),
  coverImageKey: z.string(),
  status: z.enum(["DRAFT", "LIVE", "IN_PROGRESS", "COMPLETED", "CANCELED"]),
...
const VolunteerApplicationRoleResponse = z.object({
  id: z.string(),
  title: z.string(),
});
const VolunteerApplicationResponse = z.object({
  id: z.string(),
  opportunity: VolunteerApplicationOpportunity,
  role: VolunteerApplicationRoleResponse,
  availability: z.string(),
  relevantExperience: z.string(),
  supportingDocuments: z.array(z.object({ name: z.string(), key: z.string() })),
  status: z.enum([
    "SUBMITTED",
    "UNDER_REVIEW",
    "APPROVED",
...
const CreateVolunteerApplicationResponse = z.object({
  ok: z.literal(true),
  application: VolunteerApplicationResponse,
});
const CreateVolunteerApplicationBatchRequest = z.object({
  availability: z.string(),
  relevantExperience: z.string(),
  supportingDocuments: z
    .array(
...
const CreateVolunteerApplicationBatchResponse = z.object({
  ok: z.literal(true),
  applications: z.array(VolunteerApplicationResponse),
});
const PublicVolunteerOpportunityResponse = z.object({
  id: z.string(),
  category: VolunteerOpportunityReference,
  location: VolunteerOpportunityReference,
  title: z.string(),
...
const GetPublicVolunteerOpportunityResponse = z.object({
  ok: z.literal(true),
  opportunity: PublicVolunteerOpportunityResponse,
});
const ReportingTypeResponse = z.object({ id: z.string(), type: z.string() });
const GetReportingTypesResponse = z.object({
  ok: z.boolean(),
  reportingTypes: z.array(ReportingTypeResponse),
});
const CreateReportingRequest = z.object({
  questionId: z.string(),
  answerId: z.string(),
  typeId: z
    .string()
...
const CreateReportingResponse = z.object({
  ok: z.boolean(),
  reportingId: z.string().uuid(),
});
const LaunchpadCategoryResponse = z.object({
  id: z.string(),
  name: z.string(),
  slug: z.string(),
  iconKey: z.string(),
...
const GetLaunchpadCategoriesResponse = z.object({
  ok: z.boolean(),
  categories: z.array(LaunchpadCategoryResponse),
});
const PresignLaunchpadImageUploadRequest = z.object({
  contentType: z.string(),
  fileSize: z.number().int().gt(0).lte(5242880),
});
const PresignLaunchpadLogoUploadResult = z.object({
  uploadUrl: z.string(),
  method: z.literal("PUT"),
  requiredHeaders: z.object({
    "Content-Length": z.string(),
...
const PresignLaunchpadLogoUploadResponse = z.object({
  ok: z.literal(true),
  upload: PresignLaunchpadLogoUploadResult,
});
const LaunchpadLogoValidationErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
  issues: z.array(z.object({ path: z.string(), message: z.string() })),
});
const LaunchpadOperationErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
const PresignLaunchpadCoverUploadResult = z.object({
  uploadUrl: z.string(),
  method: z.literal("PUT"),
  requiredHeaders: z.object({
    "Content-Length": z.string(),
...
const PresignLaunchpadCoverUploadResponse = z.object({
  ok: z.literal(true),
  upload: PresignLaunchpadCoverUploadResult,
});
const PresignLaunchpadDocumentUploadRequest = z.object({
  contentType: z.string(),
  fileSize: z.number().int().gt(0).lte(10485760),
});
const PresignLaunchpadDocumentUploadResult = z.object({
  uploadUrl: z.string(),
  method: z.literal("PUT"),
  requiredHeaders: z.object({
    "Content-Length": z.string(),
...
const PresignLaunchpadDocumentUploadResponse = z.object({
  ok: z.literal(true),
  upload: PresignLaunchpadDocumentUploadResult,
});
const GetSavedLaunchpadsResponse = z.object({
  ok: z.literal(true),
  launchpads: z.array(
    z.object({
      id: z.string(),
...
const CreateLaunchpadRequest = z.object({
  name: z.string().min(1).max(120),
  description: z.string().nullish(),
  categoryId: z
    .string()
...
const CreateLaunchpadResponse = z.object({
  ok: z.literal(true),
  launchpad: z.object({
    id: z.string(),
    name: z.string(),
...
const GetLaunchpadsResponse = z.object({
  ok: z.literal(true),
  launchpads: z.array(
    z.object({
      id: z.string(),
...
const UpdateLaunchpadRoleRequest = z.object({
  id: z
    .string()
    .regex(
      /^[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$\/i/,
...
const UpdateLaunchpadRequest = z
  ...
  .partial();
const GetLaunchpadByIdResponse = z.object({
  ok: z.literal(true),
  launchpad: z.object({
    id: z.string(),
    name: z.string(),
...
const PresignLaunchpadApplicationDocumentUploadRequest = z.object({
  contentType: z.string(),
  fileSize: z.number().int().gt(0).lte(10485760),
});
const PresignLaunchpadApplicationDocumentUploadResult = z.object({
  uploadUrl: z.string(),
  method: z.literal("PUT"),
  requiredHeaders: z.object({
    "Content-Length": z.string(),
...
const PresignLaunchpadApplicationDocumentUploadResponse = z.object({
  ok: z.literal(true),
  upload: PresignLaunchpadApplicationDocumentUploadResult,
});
const LaunchpadApplicationValidationErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
  issues: z.array(z.object({ path: z.string(), message: z.string() })),
});
const LaunchpadApplicationOperationErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
const CreateLaunchpadApplicationRequest = z.object({
...
const LaunchpadApplicationLog = z.object({
  id: z.string(),
  status: z.enum([
    "SUBMITTED",
    "UNDER_REVIEW",
...
const LaunchpadApplication = z.object({
  id: z.string(),
...
const CreateLaunchpadApplicationResponse = z.object({
  ok: z.literal(true),
  application: LaunchpadApplication,
});
const CreateLaunchpadApplicationBatchRequest = z.object({
  motivation: z.string().min(5).max(2000),
  portfolio: z.string().max(255).url().optional(),
  documentKeys: z.array(z.string().min(1).max(500)).max(5).optional(),
  documentNames: z.array(z.string().min(1).max(255)).max(5).optional(),
...
const CreateLaunchpadApplicationBatchResponse = z.object({
  ok: z.literal(true),
  applications: z.array(LaunchpadApplication),
});
...
const GetLaunchpadApplicationResponse = z.object({
  ok: z.literal(true),
  application: LaunchpadApplication,
});
...
const MyApplicationTimeline = z.object({
...
const MyApplicationRole = z.object({
...
const MyApplicationItem = z.object({
...
const MyApplicationsSummary = z.object({
...
const MyApplicationsResponse = z.object({
  ok: z.literal(true),
  applications: z.array(MyApplicationItem).nullable(),
  summary: MyApplicationsSummary,
});
const MyApplicationsErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
const MyApplicationRoleDetail = z.object({
  applicationId: z.string(),
  roleId: z.string(),
  title: z.string(),
  description: z.string().nullable(),
...
const MyApplicationDetail = z.object({
  id: z.string(),
  sourceType: z.enum(["VOLUNTEER", "PROJECT"]),
  title: z.string(),
  imageKey: z.string().nullable(),
...
const MyApplicationDetailResponse = z.object({
  ok: z.literal(true),
  application: MyApplicationDetail,
});
const MyApplicationStatusActionResponse = z.object({
  ok: z.literal(true),
  application: MyApplicationItem,
});
const MyApplicationArchiveActionResponse = z.object({
  ok: z.literal(true),
  application: MyApplicationItem.and(z.object({ archived: z.boolean() })),
});
...
const ProfileErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
...
const GetRecentActivitiesResponse = z.object({
  ok: z.literal(true),
  activities: z.array(RecentActivity),
});
const RecentActivityErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
const GetSavedItemsResponse = z.object({
  ok: z.literal(true),
  items: z.array(
    z.union([
      z.object({
...
const SavedItemsErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
...
const MyPostedErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
...
const ManagePostingItem = z.object({
  id: z.string(),
  sourceType: z.enum(["VOLUNTEER", "PROJECT"]),
  title: z.string(),
  description: z.string().nullable(),
...
const ManagePostingsPagination = z.object({
...
const ManagePostingsResponse = z.object({
  ok: z.literal(true),
  postings: z.array(ManagePostingItem),
  pagination: ManagePostingsPagination,
});
const ManagePostingsErrorResponse = z.object({
  ok: z.literal(false),
  error: z.string(),
});
...
const ManagePostingApplicationRole = z.object({
  applicationId: z.string(),
  roleId: z.string(),
  title: z.string(),
  description: z.string().nullable(),
...
const ManagePostingSubmission = z.object({
...
const ManagePostingApplicantPrivateNote = z.object({
  id: z.string(),
  note: z.string(),
  createdBy: z.string(),
  updatedBy: z.string(),
...
const ManagePostingApplicant = z.object({
  candidate: z.object({
    id: z.string(),
    name: z.string(),
    email: z.string(),
...
const ManagePostingCandidateDetailResponse = z.object({
  ok: z.literal(true),
  applicant: ManagePostingApplicant,
});
const UpsertManagePostingCandidateNoteRequest = z.object({
  note: z.string().max(5000),
});
const UpsertManagePostingCandidateNoteResponse = z.object({
  ok: z.literal(true),
  applicant: ManagePostingApplicant,
});
const UpdateManagePostingActionResponse = z.object({
  ok: z.literal(true),
  posting: ManagePostingItem,
});
const ExtendManagePostingDeadlineRequest = z.object({
  deadline: z.string().datetime({ offset: true }),
});
const ExtendManagePostingDeadlineResponse = z.object({
  ok: z.literal(true),
  posting: ManagePostingItem,
});
const ManagePostingApplicationActionResponse = z.object({
  ok: z.literal(true),
  applicant: ManagePostingApplicant,
});
const ManagePostingDetail = z.object({
  posting: ManagePostingItem,
  stats: z.object({
    pending: z.number().int().gte(0),
...
const ManagePostingDetailResponse = z.object({
  ok: z.literal(true),
  detail: ManagePostingDetail,
});
const postV1notificationstokens_Body = z.object({
  token: z.string().min(1),
  platform: z.enum(["web", "android", "ios"]).optional().default("web"),
});
const postV1notificationssenduser_Body = z.object({
...
const postV1notificationsbroadcast_Body = z.object({
  title: z.string().min(1),
  body: z.string().min(1),
  data: z.record(z.string(), z.string()).optional(),
  imageUrl: z.string().optional(),
...
const patchV1notificationsread_Body = z.object({
    ...
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z.object({ deadline: z.string().datetime({ offset: true }) }),
      },
      {
        name: "sourceType",
        type: "Path",
...
export type RegisterSuccessResponse = z.infer<
  typeof schemas.RegisterSuccessResponse
>;
...
export type AuthWaitlistContextResponse = z.infer<
  typeof schemas.AuthWaitlistContextResponse
>;
export type AuthCompleteSignUpRequest = z.infer<
  typeof schemas.AuthCompleteSignUpRequest
>;
...
export type CompleteSignUpResponse = z.infer<
  typeof schemas.CompleteSignUpResponse
>;
export type AuthSessionResponse = z.infer<typeof schemas.AuthSessionResponse>;
export type AuthProtectedErrorResponse = z.infer<
  typeof schemas.AuthProtectedErrorResponse
>;
...
export type AuthVerifyRegisterOtpRequest = z.infer<
  typeof schemas.AuthVerifyRegisterOtpRequest
>;
export type AuthResendRegisterOtpRequest = z.infer<
  typeof schemas.AuthResendRegisterOtpRequest
>;
export type ResendRegisterOtpResponse = z.infer<
  typeof schemas.ResendRegisterOtpResponse
>;
export type AuthSimpleErrorResponse = z.infer<
  typeof schemas.AuthSimpleErrorResponse
>;
...
export type RefreshSuccessResponse = z.infer<
  typeof schemas.RefreshSuccessResponse
>;
export type AuthForgotPasswordRequest = z.infer<
  typeof schemas.AuthForgotPasswordRequest
>;
export type ForgotPasswordResponse = z.infer<
  typeof schemas.ForgotPasswordResponse
>;
export type AuthResetPasswordRequest = z.infer<
  typeof schemas.AuthResetPasswordRequest
>;
export type ResetPasswordResponse = z.infer<
  typeof schemas.ResetPasswordResponse
>;
export type AdminLoginRequest = z.infer<typeof schemas.AdminLoginRequest>;
export type AdminLoginOtpChallengeResponse = z.infer<
  typeof schemas.AdminLoginOtpChallengeResponse
>;
export type AdminErrorResponse = z.infer<typeof schemas.AdminErrorResponse>;
export type AdminVerifyLoginOtpRequest = z.infer<
  typeof schemas.AdminVerifyLoginOtpRequest
>;
...
export type AdminPresignAvatarUploadRequest = z.infer<
  typeof schemas.AdminPresignAvatarUploadRequest
>;
export type AdminPresignAvatarUploadResponse = z.infer<
  typeof schemas.AdminPresignAvatarUploadResponse
>;
export type AdminUpdateProfileRequest = z.infer<
  typeof schemas.AdminUpdateProfileRequest
>;
export type AdminUpdateProfileResponse = z.infer<
  typeof schemas.AdminUpdateProfileResponse
>;
export type AdminLogoutResponse = z.infer<typeof schemas.AdminLogoutResponse>;
export type ContentModeratorReportType = z.infer<
  typeof schemas.ContentModeratorReportType
>;
export type ContentModeratorReportReporter = z.infer<
  typeof schemas.ContentModeratorReportReporter
>;
export type ContentModeratorReportSolver = z.infer<
  typeof schemas.ContentModeratorReportSolver
>;
export type ContentModeratorReport = z.infer<
  typeof schemas.ContentModeratorReport
>;
export type CursorPagination = z.infer<typeof schemas.CursorPagination>;
export type ListContentModeratorReportsResponse = z.infer<
  typeof schemas.ListContentModeratorReportsResponse
>;
export type UpdateContentModeratorReportReviewRequest = z.infer<
  typeof schemas.UpdateContentModeratorReportReviewRequest
>;
export type UpdateContentModeratorReportReviewResponse = z.infer<
  typeof schemas.UpdateContentModeratorReportReviewResponse
>;
export type AdminDashboardResponse = z.infer<
  typeof schemas.AdminDashboardResponse
>;
export type AdminDashboardErrorResponse = z.infer<
  typeof schemas.AdminDashboardErrorResponse
>;
export type AcceptModeratorInviteRequest = z.infer<
  typeof schemas.AcceptModeratorInviteRequest
>;
export type InviteModeratorResponse = z.infer<
  typeof schemas.InviteModeratorResponse
>;
export type Moderator = z.infer<typeof schemas.Moderator>;
export type ListModeratorsResponse = z.infer<
  typeof schemas.ListModeratorsResponse
>;
export type CreateModeratorRequest = z.infer<
  typeof schemas.CreateModeratorRequest
>;
export type ModeratorResponse = z.infer<typeof schemas.ModeratorResponse>;
export type UpdateModeratorRequest = z.infer<
  typeof schemas.UpdateModeratorRequest
>;
export type DeleteModeratorResponse = z.infer<
  typeof schemas.DeleteModeratorResponse
>;
export type AdminUserManagementTier = z.infer<
  typeof schemas.AdminUserManagementTier
>;
export type AdminUserManagementUser = z.infer<
  typeof schemas.AdminUserManagementUser
>;
export type AdminUserManagementListResponse = z.infer<
  typeof schemas.AdminUserManagementListResponse
>;
export type AdminUserManagementPoints = z.infer<
  typeof schemas.AdminUserManagementPoints
>;
export type AdminUserManagementActivity = z.infer<
  typeof schemas.AdminUserManagementActivity
>;
export type AdminUserManagementDetailUser = z.infer<
  typeof schemas.AdminUserManagementDetailUser
>;
export type AdminUserManagementDetailResponse = z.infer<
  typeof schemas.AdminUserManagementDetailResponse
>;
export type OnboardingOkResponse = z.infer<typeof schemas.OnboardingOkResponse>;
export type OnboardingErrorResponse = z.infer<
  typeof schemas.OnboardingErrorResponse
>;
export type OnboardingProfileStepRequest = z.infer<
  typeof schemas.OnboardingProfileStepRequest
>;
export type OnboardingInterestsStepRequest = z.infer<
  typeof schemas.OnboardingInterestsStepRequest
>;
export type OnboardingContributionsStepRequest = z.infer<
  typeof schemas.OnboardingContributionsStepRequest
>;
export type PresignAvatarUploadRequest = z.infer<
  typeof schemas.PresignAvatarUploadRequest
>;
export type PresignAvatarUploadResult = z.infer<
  typeof schemas.PresignAvatarUploadResult
>;
export type PresignAvatarUploadResponse = z.infer<
  typeof schemas.PresignAvatarUploadResponse
>;
export type CategoryResponse = z.infer<typeof schemas.CategoryResponse>;
export type CategoryWithQuestionCountResponse = z.infer<
  typeof schemas.CategoryWithQuestionCountResponse
>;
export type GetCategoriesResponse = z.infer<
  typeof schemas.GetCategoriesResponse
>;
export type CreateCategoryRequest = z.infer<
  typeof schemas.CreateCategoryRequest
>;
export type CreateCategoryResponse = z.infer<
  typeof schemas.CreateCategoryResponse
>;
...
export type CreateQuestionRequest = z.infer<
  typeof schemas.CreateQuestionRequest
>;
export type CreateQuestionResponse = z.infer<
  typeof schemas.CreateQuestionResponse
>;
export type TrendingTagResponse = z.infer<typeof schemas.TrendingTagResponse>;
export type GetTrendingTagsResponse = z.infer<
  typeof schemas.GetTrendingTagsResponse
>;
export type GetMyQuestionsResponse = z.infer<
  typeof schemas.GetMyQuestionsResponse
>;
export type GetSavedQuestionsResponse = z.infer<
  typeof schemas.GetSavedQuestionsResponse
>;
export type GetQuestionResponse = z.infer<typeof schemas.GetQuestionResponse>;
export type PresignForumQuestionImageUploadRequest = z.infer<
  typeof schemas.PresignForumQuestionImageUploadRequest
>;
export type PresignForumQuestionImageUploadResult = z.infer<
  typeof schemas.PresignForumQuestionImageUploadResult
>;
export type PresignForumQuestionImageUploadResponse = z.infer<
  typeof schemas.PresignForumQuestionImageUploadResponse
>;
...
export type RepliedAnswerResponse = z.infer<
  typeof schemas.RepliedAnswerResponse
>;
...
export type AnswerQuestionResponse = z.infer<
  typeof schemas.AnswerQuestionResponse
>;
export type MyAnswerResponse = z.infer<typeof schemas.MyAnswerResponse>;
export type MyAnswerDiscussionResponse = z.infer<
  typeof schemas.MyAnswerDiscussionResponse
>;
export type MyAnswersPaginationResponse = z.infer<
  typeof schemas.MyAnswersPaginationResponse
>;
...
export type MarkBestAnswerResponse = z.infer<
  typeof schemas.MarkBestAnswerResponse
>;
export type VolunteerCategoryResponse = z.infer<
  typeof schemas.VolunteerCategoryResponse
>;
export type VolunteerCategoryWithOpportunityCountResponse = z.infer<
  typeof schemas.VolunteerCategoryWithOpportunityCountResponse
>;
export type GetVolunteerCategoriesResponse = z.infer<
  typeof schemas.GetVolunteerCategoriesResponse
>;
export type VolunteerOperationErrorResponse = z.infer<
  typeof schemas.VolunteerOperationErrorResponse
>;
export type CreateVolunteerCategoryRequest = z.infer<
  typeof schemas.CreateVolunteerCategoryRequest
>;
export type CreateVolunteerCategoryResponse = z.infer<
  typeof schemas.CreateVolunteerCategoryResponse
>;
export type VolunteerCategoryValidationErrorResponse = z.infer<
  typeof schemas.VolunteerCategoryValidationErrorResponse
>;
export type VolunteerLocationResponse = z.infer<
  typeof schemas.VolunteerLocationResponse
>;
export type GetVolunteerLocationsResponse = z.infer<
  typeof schemas.GetVolunteerLocationsResponse
>;
export type PresignVolunteerOpportunityCoverUploadRequest = z.infer<
  typeof schemas.PresignVolunteerOpportunityCoverUploadRequest
>;
export type PresignVolunteerOpportunityCoverUploadResult = z.infer<
  typeof schemas.PresignVolunteerOpportunityCoverUploadResult
>;
export type PresignVolunteerOpportunityCoverUploadResponse = z.infer<
  typeof schemas.PresignVolunteerOpportunityCoverUploadResponse
>;
export type PresignVolunteerApplicationDocumentUploadRequest = z.infer<
  typeof schemas.PresignVolunteerApplicationDocumentUploadRequest
>;
export type PresignVolunteerApplicationDocumentUploadResult = z.infer<
  typeof schemas.PresignVolunteerApplicationDocumentUploadResult
>;
export type PresignVolunteerApplicationDocumentUploadResponse = z.infer<
  typeof schemas.PresignVolunteerApplicationDocumentUploadResponse
>;
export type VolunteerOpportunityReference = z.infer<
  typeof schemas.VolunteerOpportunityReference
>;
export type VolunteerOpportunityListItemResponse = z.infer<
  typeof schemas.VolunteerOpportunityListItemResponse
>;
export type VolunteerOpportunitiesPaginationResponse = z.infer<
  typeof schemas.VolunteerOpportunitiesPaginationResponse
>;
export type GetVolunteerOpportunitiesResponse = z.infer<
  typeof schemas.GetVolunteerOpportunitiesResponse
>;
export type VolunteerOpportunityContact = z.infer<
  typeof schemas.VolunteerOpportunityContact
>;
export type VolunteerOpportunityRoleRequest = z.infer<
  typeof schemas.VolunteerOpportunityRoleRequest
>;
export type CreateVolunteerOpportunityPayload = z.infer<
  typeof schemas.CreateVolunteerOpportunityPayload
>;
export type CreateVolunteerOpportunityRequest = z.infer<
  typeof schemas.CreateVolunteerOpportunityRequest
>;
export type VolunteerOpportunityContactResponse = z.infer<
  typeof schemas.VolunteerOpportunityContactResponse
>;
export type VolunteerOpportunityOrganizerResponse = z.infer<
  typeof schemas.VolunteerOpportunityOrganizerResponse
>;
export type VolunteerOpportunityRoleResponse = z.infer<
  typeof schemas.VolunteerOpportunityRoleResponse
>;
export type VolunteerOpportunityResponse = z.infer<
  typeof schemas.VolunteerOpportunityResponse
>;
export type CreateVolunteerOpportunityResponse = z.infer<
  typeof schemas.CreateVolunteerOpportunityResponse
>;
export type GetVolunteerOpportunityResponse = z.infer<
  typeof schemas.GetVolunteerOpportunityResponse
>;
export type UpdateVolunteerOpportunityContactRequest = z.infer<
  typeof schemas.UpdateVolunteerOpportunityContactRequest
>;
export type UpdateVolunteerOpportunityRoleRequest = z.infer<
  typeof schemas.UpdateVolunteerOpportunityRoleRequest
>;
export type UpdateVolunteerOpportunityRequest = z.infer<
  typeof schemas.UpdateVolunteerOpportunityRequest
>;
export type SaveVolunteerOpportunityResponse = z.infer<
  typeof schemas.SaveVolunteerOpportunityResponse
>;
export type CreateVolunteerApplicationRequest = z.infer<
  typeof schemas.CreateVolunteerApplicationRequest
>;
export type VolunteerApplicationOpportunity = z.infer<
  typeof schemas.VolunteerApplicationOpportunity
>;
export type VolunteerApplicationRoleResponse = z.infer<
  typeof schemas.VolunteerApplicationRoleResponse
>;
export type VolunteerApplicationResponse = z.infer<
  typeof schemas.VolunteerApplicationResponse
>;
export type CreateVolunteerApplicationResponse = z.infer<
  typeof schemas.CreateVolunteerApplicationResponse
>;
export type CreateVolunteerApplicationBatchRequest = z.infer<
  typeof schemas.CreateVolunteerApplicationBatchRequest
>;
export type CreateVolunteerApplicationBatchResponse = z.infer<
  typeof schemas.CreateVolunteerApplicationBatchResponse
>;
export type PublicVolunteerOpportunityResponse = z.infer<
  typeof schemas.PublicVolunteerOpportunityResponse
>;
export type GetPublicVolunteerOpportunityResponse = z.infer<
  typeof schemas.GetPublicVolunteerOpportunityResponse
>;
export type ReportingTypeResponse = z.infer<
  typeof schemas.ReportingTypeResponse
>;
export type GetReportingTypesResponse = z.infer<
  typeof schemas.GetReportingTypesResponse
>;
export type CreateReportingRequest = z.infer<
  typeof schemas.CreateReportingRequest
>;
export type CreateReportingResponse = z.infer<
  typeof schemas.CreateReportingResponse
>;
export type LaunchpadCategoryResponse = z.infer<
  typeof schemas.LaunchpadCategoryResponse
>;
export type GetLaunchpadCategoriesResponse = z.infer<
  typeof schemas.GetLaunchpadCategoriesResponse
>;
export type PresignLaunchpadImageUploadRequest = z.infer<
  typeof schemas.PresignLaunchpadImageUploadRequest
>;
export type PresignLaunchpadLogoUploadResult = z.infer<
  typeof schemas.PresignLaunchpadLogoUploadResult
>;
export type PresignLaunchpadLogoUploadResponse = z.infer<
  typeof schemas.PresignLaunchpadLogoUploadResponse
>;
export type LaunchpadLogoValidationErrorResponse = z.infer<
  typeof schemas.LaunchpadLogoValidationErrorResponse
>;
export type LaunchpadOperationErrorResponse = z.infer<
  typeof schemas.LaunchpadOperationErrorResponse
>;
export type PresignLaunchpadCoverUploadResult = z.infer<
  typeof schemas.PresignLaunchpadCoverUploadResult
>;
export type PresignLaunchpadCoverUploadResponse = z.infer<
  typeof schemas.PresignLaunchpadCoverUploadResponse
>;
export type PresignLaunchpadDocumentUploadRequest = z.infer<
  typeof schemas.PresignLaunchpadDocumentUploadRequest
>;
export type PresignLaunchpadDocumentUploadResult = z.infer<
  typeof schemas.PresignLaunchpadDocumentUploadResult
>;
export type PresignLaunchpadDocumentUploadResponse = z.infer<
  typeof schemas.PresignLaunchpadDocumentUploadResponse
>;
export type GetSavedLaunchpadsResponse = z.infer<
  typeof schemas.GetSavedLaunchpadsResponse
>;
export type SaveLaunchpadResponse = z.infer<
  typeof schemas.SaveLaunchpadResponse
>;
export type CreateLaunchpadRequest = z.infer<
  typeof schemas.CreateLaunchpadRequest
>;
export type CreateLaunchpadResponse = z.infer<
  typeof schemas.CreateLaunchpadResponse
>;
export type GetLaunchpadsResponse = z.infer<
  typeof schemas.GetLaunchpadsResponse
>;
export type UpdateLaunchpadRoleRequest = z.infer<
  typeof schemas.UpdateLaunchpadRoleRequest
>;
export type UpdateLaunchpadRequest = z.infer<
  typeof schemas.UpdateLaunchpadRequest
>;
export type GetLaunchpadByIdResponse = z.infer<
  typeof schemas.GetLaunchpadByIdResponse
>;
export type PresignLaunchpadApplicationDocumentUploadRequest = z.infer<
  typeof schemas.PresignLaunchpadApplicationDocumentUploadRequest
>;
export type PresignLaunchpadApplicationDocumentUploadResult = z.infer<
  typeof schemas.PresignLaunchpadApplicationDocumentUploadResult
>;
export type PresignLaunchpadApplicationDocumentUploadResponse = z.infer<
  typeof schemas.PresignLaunchpadApplicationDocumentUploadResponse
>;
export type LaunchpadApplicationValidationErrorResponse = z.infer<
  typeof schemas.LaunchpadApplicationValidationErrorResponse
>;
export type LaunchpadApplicationOperationErrorResponse = z.infer<
  typeof schemas.LaunchpadApplicationOperationErrorResponse
>;
export type CreateLaunchpadApplicationRequest = z.infer<
  typeof schemas.CreateLaunchpadApplicationRequest
>;
export type LaunchpadApplicationLog = z.infer<
  typeof schemas.LaunchpadApplicationLog
>;
export type LaunchpadApplication = z.infer<typeof schemas.LaunchpadApplication>;
export type CreateLaunchpadApplicationResponse = z.infer<
  typeof schemas.CreateLaunchpadApplicationResponse
>;
export type CreateLaunchpadApplicationBatchRequest = z.infer<
  typeof schemas.CreateLaunchpadApplicationBatchRequest
>;
export type CreateLaunchpadApplicationBatchResponse = z.infer<
  typeof schemas.CreateLaunchpadApplicationBatchResponse
>;
export type LaunchpadApplicationBatchErrorResponse = z.infer<
  typeof schemas.LaunchpadApplicationBatchErrorResponse
>;
export type GetLaunchpadApplicationResponse = z.infer<
  typeof schemas.GetLaunchpadApplicationResponse
>;
export type MyApplicationStatusGroup = z.infer<
  typeof schemas.MyApplicationStatusGroup
>;
export type MyApplicationReference = z.infer<
  typeof schemas.MyApplicationReference
>;
export type MyApplicationTimeline = z.infer<
  typeof schemas.MyApplicationTimeline
>;
...
export type MyApplicationsSummary = z.infer<
  typeof schemas.MyApplicationsSummary
>;
export type MyApplicationsResponse = z.infer<
  typeof schemas.MyApplicationsResponse
>;
export type MyApplicationsErrorResponse = z.infer<
  typeof schemas.MyApplicationsErrorResponse
>;
export type MyApplicationRoleDetail = z.infer<
  typeof schemas.MyApplicationRoleDetail
>;
export type MyApplicationDetail = z.infer<typeof schemas.MyApplicationDetail>;
export type MyApplicationDetailResponse = z.infer<
  typeof schemas.MyApplicationDetailResponse
>;
export type MyApplicationStatusActionResponse = z.infer<
  typeof schemas.MyApplicationStatusActionResponse
>;
export type MyApplicationArchiveActionResponse = z.infer<
  typeof schemas.MyApplicationArchiveActionResponse
>;
...
export type UpdateProfileResponse = z.infer<
  typeof schemas.UpdateProfileResponse
>;
export type RecentActivity = z.infer<typeof schemas.RecentActivity>;
export type GetRecentActivitiesResponse = z.infer<
  typeof schemas.GetRecentActivitiesResponse
>;
export type RecentActivityErrorResponse = z.infer<
  typeof schemas.RecentActivityErrorResponse
>;
export type GetSavedItemsResponse = z.infer<
  typeof schemas.GetSavedItemsResponse
>;
export type SavedItemsErrorResponse = z.infer<
  typeof schemas.SavedItemsErrorResponse
>;
export type PublicProfileResponse = z.infer<
  typeof schemas.PublicProfileResponse
>;
export type GetMyPostedResponse = z.infer<typeof schemas.GetMyPostedResponse>;
export type MyPostedErrorResponse = z.infer<
  typeof schemas.MyPostedErrorResponse
>;
...
export type ManagePostingsPagination = z.infer<
  typeof schemas.ManagePostingsPagination
>;
export type ManagePostingsResponse = z.infer<
  typeof schemas.ManagePostingsResponse
>;
export type ManagePostingsErrorResponse = z.infer<
  typeof schemas.ManagePostingsErrorResponse
>;
export type ManagePostingApplicantStatus = z.infer<
  typeof schemas.ManagePostingApplicantStatus
>;
export type ManagePostingApplicationRole = z.infer<
  typeof schemas.ManagePostingApplicationRole
>;
export type ManagePostingSubmission = z.infer<
  typeof schemas.ManagePostingSubmission
>;
export type ManagePostingApplicantPrivateNote = z.infer<
  typeof schemas.ManagePostingApplicantPrivateNote
>;
export type ManagePostingApplicant = z.infer<
  typeof schemas.ManagePostingApplicant
>;
export type ManagePostingCandidateDetailResponse = z.infer<
  typeof schemas.ManagePostingCandidateDetailResponse
>;
export type UpsertManagePostingCandidateNoteRequest = z.infer<
  typeof schemas.UpsertManagePostingCandidateNoteRequest
>;
export type UpsertManagePostingCandidateNoteResponse = z.infer<
  typeof schemas.UpsertManagePostingCandidateNoteResponse
>;
export type UpdateManagePostingActionResponse = z.infer<
  typeof schemas.UpdateManagePostingActionResponse
>;
export type ExtendManagePostingDeadlineRequest = z.infer<
  typeof schemas.ExtendManagePostingDeadlineRequest
>;
export type ExtendManagePostingDeadlineResponse = z.infer<
  typeof schemas.ExtendManagePostingDeadlineResponse
>;
export type ManagePostingApplicationActionResponse = z.infer<
  typeof schemas.ManagePostingApplicationActionResponse
>;
export type ManagePostingDetail = z.infer<typeof schemas.ManagePostingDetail>;
export type ManagePostingDetailResponse = z.infer<
  typeof schemas.ManagePostingDetailResponse
>;
export type postV1notificationstokens_Body = z.infer<
  typeof schemas.postV1notificationstokens_Body
>;
export type postV1notificationssenduser_Body = z.infer<
  typeof schemas.postV1notificationssenduser_Body
>;
export type postV1notificationsbroadcast_Body = z.infer<
  typeof schemas.postV1notificationsbroadcast_Body
>;
export type patchV1notificationsread_Body = z.infer<
  typeof schemas.patchV1notificationsread_Body
>;
